...
if __name__ == '__main__':
    ...
    for xs, xt, zs, zt in zip(Xs, Xt, Xs_new, Xt_new):
        if random.random() < 0.1:
            c1, c2 = zs
            ax.imshow(xs.reshape((40, 40)), extent=(c1-0.1, c1+0.1, c2-0.1, c2+0.1), alpha=0.5, cmap='GnBu')
            c1, c2 = zt
            ax.imshow(xt.reshape((40, 40)), extent=(c1-0.1, c1+0.1, c2-0.1, c2+0.1), alpha=0.5, cmap='RdPu')
